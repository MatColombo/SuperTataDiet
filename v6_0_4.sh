...
cd "$ROOT_DIR"
bash build.sh
node scripts/test_v6_0_4_savestate.js
node scripts/test_v6_0_3_night_tail.js >/dev/null
node scripts/test_v6_0_3_backup.js >/dev/null
...
python3 scripts/test_v6_0_4.py
