/* TataDiet 6.0 - service worker stabile, scope-safe anche su GitHub Pages project site. */
"use strict";
...
const CORE_ASSETS = [
  ...
  "assets/js/v6-ingredient-intelligence-core.js",
  "assets/js/v6-constraint-core.js",
  "assets/js/v6-intelligence-store.js",
  "assets/js/v6-planner-core.js",
  "assets/js/v6-planner-store.js",
  "assets/js/v6-recipe-converter.js",
  "assets/js/v6-diary-core.js",
  "assets/js/v6-diary-store.js",
  "assets/js/v6-diary.js",
  ...
  "data/v6/phase-a-policy.json",
  "data/v6/phase-c1-policy.json",
  "data/v6/phase-c2-policy.json",
  "data/v6/phase-d-policy.json",
  "data/v6/phase-e-policy.json",
  "data/v6/phase-f-policy.json",
  "data/v6/phase-g-policy.json",
  "data/v6/phase-h-policy.json",
