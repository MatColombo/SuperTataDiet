...
def main() -> int:
    ...
    existing_files = {p.resolve() for p in DOCS.rglob("*") if p.is_file()}
    ...
    def soup_for(path: Path):
        ...
        if path not in soup_cache:
            soup_cache[path] = BeautifulSoup(path.read_text(encoding="utf-8"), "html.parser")
        return soup_cache[path]

    def ids_for(path: Path) -> set[str]:
        path = path.resolve()
        if path not in id_cache:
            id_cache[path] = {str(tag.get("id")) for tag in soup_for(path).find_all(attrs={"id": True})}
    ...
    required = [
        "oggi/index.html", "diario/index.html", "calendario/index.html", "calendario/modifica/index.html", "preparazioni/index.html", "cerca/index.html",
        ...
        "assets/js/operations-core.js", "assets/js/v6-diary-core.js", "assets/js/v6-diary-store.js", "assets/js/v6-diary.js", "assets/js/v5-planning-core.js", "assets/js/v5-balance.js", "assets/js/v5-recipe-scheduler.js", "assets/js/v5-plan-core.js", "assets/js/v5-plan-store.js", "assets/js/v5-plan.js", "assets/js/v5-plan-calendar.js", "assets/js/prep.js", "assets/js/shopping-range.js",
        ...
        "data/offline-assets.json", "data/v6/phase-g-policy.json", "data/v6/phase-h-policy.json",
    ]
