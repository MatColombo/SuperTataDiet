...
def main() -> None:
    ...
    render(
        "diary.html", "diario/index.html", title="Diario", nav="diary", page_id="diary",
        breadcrumbs=[{"label": "Panoramica", "path": "index.html"}, {"label": "Diario"}],
    )
    render(
    ...
    completed = [
        ...
        "Release 6.0.4: backup full come savestate, ripristino del piano attivo su dispositivo vergine e bridge browser coerente",
    ]
    todo = [
        "Smoke visuale/interattivo post-deploy su desktop e mobile (convertitore, picker, Diario)",
        "Verifica installazione, aggiornamento e comportamento standalone PWA su Android e iOS reali",
        "Backlog futuro: preferiti e pianificazione batch-cooking/dispensa personale",
    ]
    decisions = [
        ...
        {"title": "Fonte dati", "text": "Il baseline V6 curato e congelato nei JSON tatadiet-base-v2 è la fonte autorevole runtime; Excel/PDF originali restano fonti di provenienza, mentre IndexedDB applica il livello personale effettivo."},
    ...
    # V6 Phase E: publish the constraint, ingredient-intelligence and planner policies.
    v6_out = DOCS / "data" / "v6"
    ...
    for source_name in [
        ...
        shutil.copy2(ROOT / "spec" / "v6" / source_name, v6_out / source_name)
