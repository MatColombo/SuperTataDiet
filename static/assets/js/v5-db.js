(function (global, factory) {
  ...
  const STORE_SPECS = {
    ...
    diaryDays: { keyPath: "id", indexes: [["planInstanceId", "planInstanceId"], ["date", "date"], ["updatedAt", "updatedAt"]] },
  };

  const personalStores = ["ingredients", "ingredientRevisions", "recipes", "recipeVersions", "planInstances", "calendarDays", "operations", "shoppingChecklists", "diaryDays"];
  const backupStores = ["ingredients", "ingredientRevisions", "recipes", "recipeVersions", "planInstances", "calendarDays", "operations", "diaryDays"];
