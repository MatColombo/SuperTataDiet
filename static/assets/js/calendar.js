(() => {
  ...
  const renderToday = (data, start) => {
    ...
    if (pageEyebrow) pageEyebrow.textContent = `Versione V${document.body?.dataset.version || "6.0.2"} · ${selectedDate === actualToday ? "piano alimentare di oggi" : "consultazione giornata"}`;
